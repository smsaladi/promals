...
void banmul(double **a, unsigned long n, int m1, int m2, double x[],
            double b[]);
...
void ks2d1s(double x1[], double y1[], unsigned long n1,
            void (*quadvl)(double, double, double *, double *, double *,
                           double *),
            double *d1, double *prob);
void ks2d2s(double x1[], double y1[], unsigned long n1, double x2[],
            double y2[], unsigned long n2, double *d, double *prob);
...
void miser(double (*func)(double[]), double regn[], int ndim,
           unsigned long npts, double dith, double *ave, double *var);
...
void red(int iz1, int iz2, int jz1, int jz2, int jm1, int jm2, int jmf, int ic1,
         int jc1, int jcf, int kc, double ***c, double **s);
...
void spear(double data1[], double data2[], unsigned long n, double *d,
           double *zd, double *probd, double *rs, double *probrs);
...
void sprstm(double sa[], unsigned long ija[], double sb[], unsigned long ijb[],
            double thresh, unsigned long nmax, double sc[],
            unsigned long ijc[]);
