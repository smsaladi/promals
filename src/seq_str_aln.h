...
//sequence alignments between a query sequence and hits with known structures from SCOP40 
...
class seq_str_aln {
	...
	void run_blast(char *blastexe, char *fasta_file, char *database, char *suffix, char *chkfile, char *options);
