...
class MM {
 ...
 private:
  ...
  int diff(int A, int B, int M, int N, int tb,
           int te);  // simple Myers-Miller with affine gap penalties
  int diff1(int A, int B, int M, int N, int tb,
            int te);  // also consider the situation of no end gap penalties
