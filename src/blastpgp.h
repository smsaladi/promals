...
extern subalign* get_blastpgp_alignment(char *basename, char *query_name, char *query_seq);
...
extern subalign *read_blastpgp_result(const char *blastpgp_result, char *query_name, char *query_seq);

extern void purge_alignment_by_first_sequence(subalign *x);

extern subalign *get_blastpgp_result(const char *blastpgp_result, char *query_name, char *query_seq);
