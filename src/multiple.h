...
class multiple {
	...
	void combine_structure_alignment();
        ...
        void get_kcenter_clusters(int dim, int nc, int maxelem, int maxiter, int maxinit);
...
int **get_salnpos_updated(seq_str_aln *name1, seq_str_aln *name2, int ind1, int ind2, int &numalignedp, char *prog_name);
